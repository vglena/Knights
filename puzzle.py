...
knowledge3 = And(
    ...
    Or(
        And(A_said_knave, Biconditional(AKnight, AKnave)),
        And(Not(A_said_knave), Biconditional(AKnight, AKnight))
    ),

    # B says: A said "I am a knave"
    Biconditional(BKnight, A_said_knave),
    Biconditional(BKnave, Not(A_said_knave)),
